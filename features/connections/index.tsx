    ...
    <div className="w-full relative">
      ...
      <div className="max-w-[1136px] mx-auto px-4 md:px-8 lg:px-12 mt-12 relative">
        <Tabs defaultValue="active" className="w-full">
          ...
          <div className="relative h-12 mb-16"> {/* This helps to reserve space */}
          ...
          <TabsContent value="active">
            <EmptyConnections title="You haven’t connected with any caregivers" description="Explore and connect with caregivers on the ULO platform by clicking the button below." />
          </TabsContent>

          {/* Hired Tab Content */}
          <TabsContent value="hired">
            <EmptyConnections title="You aren’t currently hiring any caregivers" description="Caregivers you connect with and hire on the ULO platform will show up here." />
          </TabsContent>
        </Tabs>
      </div>
    </div>
